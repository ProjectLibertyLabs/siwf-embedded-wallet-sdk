declare type CurveType = "Sr25519" | "Secp256k1";
declare type AlgorithmType = "SR25519" | "SECP256K1";
declare type SupportedPayload = unknown;
export declare type SignedPayload = Uint8Array | SupportedPayload;
...
export declare type SiwfResponsePayload = SiwfResponsePayloadAddProvider | SiwfResponsePayloadItemActions | SiwfResponsePayloadClaimHandle | SiwfResponsePayloadBase;
...
export declare type SiwfResponseCredential = SiwfResponseCredentialEmail | SiwfResponseCredentialPhone | SiwfResponseCredentialGraph;
