...
BASE_NAME=siwf-embedded-wallet

ALL_PROFILES="account content_publishing content_watcher backend frontend"
BACKEND_ONLY_PROFILES="account content_publishing content_watcher backend"
